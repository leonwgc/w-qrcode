...
(self.webpackChunkw_qrcode = self.webpackChunkw_qrcode || []).push([
  [826],
  {
    128: (t, e, r) => {
      ...
      (s.prototype = {
        ...
        (h.prototype = {
          ...
          setupTypeInfo: function (t, e) {
            for (
              var r = (this.errorCorrectLevel << 3) | e, o = f.getBCHTypeInfo(r), i = 0;
              i < 15;
              i++
            ) {
              var n = !t && 1 == ((o >> i) & 1);
        ...
        (h.createData = function (t, e, r) {
          for (var o = p.getRSBlocks(t, e), i = new m(), n = 0; n < r.length; n++) {
            var a = r[n];
            i.put(a.mode, 4), i.put(a.getLength(), f.getLengthInBits(a.mode, t)), a.write(i);
          }
          var s = 0;
          ...
          for (
            ;
            !(i.getLengthInBits() >= 8 * s || (i.put(h.PAD0, 8), i.getLengthInBits() >= 8 * s));
        ...
        (h.createBytes = function (t, e) {
          for (
            ...
            var g = f.getErrorCorrectPolynomial(l),
              c = new d(n[s], g.getLength() - 1).mod(g);
            for (a[s] = new Array(g.getLength() - 1), u = 0; u < a[s].length; u++) {
              var p = u + c.getLength() - a[s].length;
              a[s][u] = p >= 0 ? c.get(p) : 0;
            }
          }
          var m = 0;
      ...
      for (c = 8; c < 256; c++)
        g.EXP_TABLE[c] =
          g.EXP_TABLE[c - 4] ^ g.EXP_TABLE[c - 5] ^ g.EXP_TABLE[c - 6] ^ g.EXP_TABLE[c - 8];
        ...
        multiply: function (t) {
          for (
            ...
            for (var o = 0; o < t.getLength(); o++)
              e[r + o] ^= g.gexp(g.glog(this.get(r)) + g.glog(t.get(o)));
          return new d(e, 0);
        },
        mod: function (t) {
          if (this.getLength() - t.getLength() < 0) return this;
          for (
            var e = g.glog(this.get(0)) - g.glog(t.get(0)), r = new Array(this.getLength()), o = 0;
            o < this.getLength();
            o++
          )
            r[o] = this.get(o);
          for (o = 0; o < t.getLength(); o++) r[o] ^= g.gexp(g.glog(t.get(o)) + e);
          return new d(r, 0).mod(t);
        },
      }),
        (p.RS_BLOCK_TABLE = [
          [1, 26, 19],
      ...
      if (A && A <= 2.1) {
        var E = 1 / window.devicePixelRatio,
          L = CanvasRenderingContext2D.prototype.drawImage;
        CanvasRenderingContext2D.prototype.drawImage = function (t, e, r, o, i, n, a, s, h) {
          if ('nodeName' in t && /img/i.test(t.nodeName))
            for (var l = arguments.length - 1; l >= 1; l--) arguments[l] = arguments[l] * E;
          else
            void 0 === s &&
              ((arguments[1] *= E), (arguments[2] *= E), (arguments[3] *= E), (arguments[4] *= E));
        ...
        for (var l = 0; l < i; l++)
          for (var u = 0; u < i; u++) {
            ...
            (r.strokeStyle = f ? o.colorDark : o.colorLight),
              ...
              r.fillRect(g, c, n, a),
              r.strokeRect(Math.floor(g) + 0.5, Math.floor(c) + 0.5, s, h),
              r.strokeRect(Math.ceil(g) - 0.5, Math.ceil(c) - 0.5, s, h);
          }
        this._bIsPainted = !0;
      }),
        (B.prototype.makeImage = function () {
          this._bIsPainted && y.call(this, D);
        }),
      ...
      function I() {
        ...
        return (
          ...
          (0, n.Z)(function () {
            new M(t.current, { text: 'https://baidu.com/' });
          }),
          o.createElement(a.Z, null, o.createElement('div', { ref: t }))
        );
      }
      i.render(o.createElement(I, null), document.querySelector('#root'));
    },
  },
  (t) => {
    t.O(0, [736], () => (128, t((t.s = 128)))), t.O();
  },
]);
